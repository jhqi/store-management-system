...
class Ui_update_in_log(object):
    ...
    def retranslateUi(self, update_in_log):
        ...
        update_in_log.setWindowTitle(_translate("update_in_log", "确认修改入库记录"))
        self.label_6.setText(_translate("update_in_log", "入库日期："))
        self.label_2.setText(_translate("update_in_log", "存货编码："))
        self.label_3.setText(_translate("update_in_log", "存货名称："))
        self.label.setText(_translate("update_in_log", "规格型号："))
        self.label_9.setText(_translate("update_in_log", "单价(元)："))
        self.label_10.setText(_translate("update_in_log", "库存位置："))
        self.label_4.setText(_translate("update_in_log", "操作类型："))
        self.comboBox.setItemText(0, _translate("update_in_log", "入库"))
        self.comboBox.setItemText(1, _translate("update_in_log", "出库"))
        self.label_5.setText(_translate("update_in_log", "操作数量："))
        self.label_7.setText(_translate("update_in_log", "使用人员："))
        self.label_8.setText(_translate("update_in_log", "令号："))
        self.cancel_pushButton.setText(_translate("update_in_log", "取消"))
        self.both_btn.setText(_translate("update_in_log", "修改入库记录和结存数量"))
